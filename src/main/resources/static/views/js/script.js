  ...
  a(document).ready(function () {
    function d() {
      a("#bars").on("click", function () {
        return (
          0 == a(".navigation").hasClass("nav-active") &&
            a(".navigation").addClass("nav-active"),
        ...
        a("#bars-close").on("click", function () {
          return (
            a(".navigation").hasClass("nav-active") &&
              a(".navigation").removeClass("nav-active"),
    ...
    function e() {
      a("#menu > li").each(function () {
        a(this).find("> ul").length &&
          (a(this).append('<span><i class="fa fa-angle-down"></i></span>'),
          a(this)
            .find("li")
            .each(function () {
              a(this).find("ul").length &&
    ...
    function f() {
      var b = a(".navigation").data("menu-type"),
        ...
        f = a(".header");
      b > d
        ? (e.addClass("nav").removeClass("nav-desktop").closest(".header"),
          f.next().css("margin-top", 0),
          a(".bars, .bars-close, .logo-banner").show(),
          a(".navigation .sub-menu").each(function () {
            a(this).removeClass("left right");
          }))
        : (e.removeClass("nav").addClass("nav-desktop").closest(".header"),
          f
            .css("background-color", "#fff")
            .find(".logo")
            .css({ opacity: "1", visibility: "visible" }),
          f.next().css("margin-top", a(".header").height()),
          a(".bars, .bars-close").hide(),
          a(".navigation .sub-menu").each(function () {
            var b = a(this).offset().left,
              d = a(this).width(),
              e = c - (b + d);
            60 > e
              ? a(this).removeClass("left").addClass("right")
              : a(this).removeClass("right"),
              60 > b
                ? a(this).removeClass("right").addClass("left")
                : a(this).removeClass("left");
          }));
    }
    function g() {
      var b = a("#menu"),
      ...
      b.length &&
        (d > 0
          ? d >= e
            ? f.length &&
              0 == f.hasClass("header-responsive") &&
              f.addClass("header-responsive")
            : (f.length &&
                1 == f.hasClass("header-responsive") &&
                a(".header").removeClass("header-responsive"),
    ...
    function h() {
      a(".navigation.nav .menu-parent").on("click", " > a", function () {
        var b = a(this);
        return (
          0 == b.parent().hasClass("active")
            ? (b.parent("li").addClass("active"),
              b.parent().find(">ul").slideDown())
            : (b.parent("li").removeClass("active"),
              b.parent("li").find(">ul").slideUp()),
          !1
        );
      });
    }
    ...
    function k() {
      a(".form-field .field-input")
        ...
        .on("keyup", function () {
          ...
          "" != b.val()
            ? 0 == c.hasClass("forcus") && c.addClass("focus")
            : c.removeClass("focus");
        });
    }
    function l() {
      ...
      if (a("#owl-magazine-ds").length) {
        a("#owl-magazine-ds").owlCarousel({
          ...
          afterAction: function () {
            ...
            b.find(".active").removeClass("active"),
              b.find(".thumnail-item").eq(this.currentItem).addClass("active");
          },
        });
        ...
        a("#magazine-thum").on("click", ".thumnail-item", function () {
          ...
          if (0 == c.hasClass("active")) {
            var d = a(this).index();
            c.parent("#magazine-thum").find(".active").removeClass("active"),
              c.addClass("active"),
              b.goTo(d);
          }
        });
    ...
    function n() {
      ...
      b > 100
        ? 0 == a("#header").hasClass("header-stick") &&
          (a("#header").addClass("header-stick"),
          a(".navigation.nav")
            .closest("body")
            .find("#header")
            .find(".logo")
            .css({ opacity: "1", visibility: "visible" }))
        : (a("#header").removeClass("header-stick"),
          a(".navigation.nav")
            .closest("body")
            .find("#header")
      ...
      a(".price-slider").length &&
        a(".price-slider").slider({
          ...
          create: function () {
            ...
            d.slider("values", e),
              d.prepend("<label class='label-min'>" + e[0] + "</label>"),
              d.append("<label class='label-max'>" + e[1] + "</label>");
          },
          slide: function (b, c) {
            var d = a(this),
              e = c.values;
            d.find(".label-min").text("" + e[0]),
              d.find(".label-max").text("" + e[1]),
              d.find(".range").attr("value", e);
          },
        });
    }
    function p() {
      a(".time-slider").length &&
        a(".time-slider").slider({
          min: 0,
          max: 1440,
          step: 1,
          create: function () {
            ...
            if (0 == isNaN(f)) {
              ...
              var h = Math.floor(f / 60),
                i = q(h, f - 60 * h, !0),
                j = q(g, e - 60 * g, !0);
              d.prepend("<label class='label-min'>" + j + "</label>"),
                d.append("<label class='label-max'>" + i + "</label>"),
                d.find(".range").attr("value", j + "," + i);
            } else {
              var j = q(g, e - 60 * g, !1);
              d.slider("value", e),
                d.slider("option", "range", "min"),
                d.append("<label class='label-max'>" + j + "</label>"),
                d.find(".range").attr("value", j);
            }
          },
          slide: function (b, c) {
            var f,
            ...
            1 == e
              ? ((f = c.values),
                ...
                (i = q(g, f[0] - 60 * g, !0)),
                (j = q(h, f[1] - 60 * h, !0)),
                d.find(".label-min").text(i),
                d.find(".label-max").text(j),
                d.find(".range").attr("value", i + "," + j))
              : ((f = c.value),
                (g = Math.floor(f / 60)),
                (i = q(g, f - 60 * g, !1)),
                d.find(".label-max").text(i),
                d.find(".range").attr("value", i));
          },
        });
    }
    function q(a, b, c) {
    ...
    function r() {
      function d() {
        ...
        c.find(".owl-item").removeClass("synced").eq(d).addClass("synced"),
          void 0 !== a("#slide-room-sm").data("owlCarousel") && e(d);
      }
      function e(a) {
        ...
        0 == e
          ? d > b[b.length - 1]
            ? c.trigger("owl.goTo", d - b.length + 2)
            : (-1 == d - 1 && (d = 0), c.trigger("owl.goTo", d))
          : d == b[b.length - 1]
          ? c.trigger("owl.goTo", b[1])
          : d == b[0] && c.trigger("owl.goTo", d - 1);
      }
    ...
    function s() {
      a(".progress-rv").each(function () {
        var d = a(this).attr("data-value"),
          e = 10 * d;
        a(this).append(
          "<div style='width:" + e + "%'><span>" + d + "</span></div>"
        );
      });
    }
    function t() {
      a(".post-slide").length > 0 &&
        a(".post-slide").owlCarousel({
          autoPlay: 8e3,
          slideSpeed: 1e3,
          navigation: !0,
          pagination: !1,
    ...
    function u() {
      a(".page-slide").length > 0 &&
        a(".page-slide").owlCarousel({
          autoPlay: 1e4,
          slideSpeed: 1e3,
          navigation: !1,
          pagination: !0,
    ...
    function v() {
      a(".table-radio tbody tr").on("click", function () {
        var b = a(this);
        0 == b.hasClass("warning") &&
          (b.parents(".table-radio").find(".warning").removeClass("warning"),
          b.addClass("warning"),
          b.find(".radio").prop("checked", !0));
      });
    }
    function w() {
      a(".scroll-table").length &&
        (b.any() ||
          a(".scroll-table").niceScroll({
            touchbehavior: !1,
            background: "#e2e2e2",
            cursoropacitymin: 1,
            cursorcolor: "#141414",
        ...
        a(".detail-cn").each(function () {
          ...
          a(".scroll-heading a").on("click", function () {
            ...
            return (
              a("html, body")
                .stop()
                .animate({ scrollTop: a(b).offset().top - 70 }, 1e3),
              !1
            );
          });
      }
    ...
    function y() {
      a(".bar-cl .fill").each(function () {
        ...
        a(".ul-bar li").on("click", ".bar-cl", function () {
          a(this).parents(".ul-bar").find(".active").removeClass("active"),
            a(this).parents("li").addClass("active");
        });
    }
    function z() {
      c > 1199 &&
        a(".bg-parallax").length &&
        a(".bg-parallax").each(function () {
          a(this).parallax("50%", 0.1);
        });
    }
    function B() {
      if (a("#hotel-maps").length) {
        ...
        var h,
          ...
          g = new google.maps.InfoWindow({ maxWidth: 600 }),
    ...
    function C() {
      if (a("#contact-maps").length) {
        var b = a("#contact-maps"),
          ...
          j = new google.maps.Marker({ position: g });
        j.setMap(i);
      ...
      a("#contact-form").length > 0 &&
        a("#contact-form").validate({
          ...
          submitHandler: function (b) {
            return (
              a("#submit-contact").html("Sending..."),
              a(b).ajaxSubmit({
                success: function (b) {
                  a("#contact-content").slideUp(600, function () {
                    a("#contact-content").html(b).slideDown(600),
                      a(".submit-contact").html("Submit");
                  });
                },
              }),
              !1
